...
class ServicesCreateButton extends StatefulWidget {
  @override
  _ServicesCreateButtonState createState() =>
      _ServicesCreateButtonState();
}

class _ServicesCreateButtonState
    extends State<ServicesCreateButton> {
  late bool isLoading;
      ...
      child: (isLoading)
          ...
          : ElevatedButton(
              ...
              onPressed: () async {
                ...
                servicesDataTableBloc.addService(service).then((value) {
                  if (value)

...
import 'package:scrubbers_employee_application/core/data/datasources/appointment_slot/appointment_slot_local_data_source.dart';
...
registerCore(GetIt sl) {
  ...
  sl.registerLazySingleton<AppointmentSlotRepository>(() => AppointmentSlotRepositoryImpl(sl()));
  ...
  sl.registerLazySingleton<AppointmentSlotLocalDataSource>(() => AppointmentSlotLocalDataSourceImpl());
}
